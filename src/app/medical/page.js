...
export default function MedicalPage() {
  ...
  const medicalTests = [
    { title: "NEET UG", image: medical.src, bgColor: "bg-blue-400", hoverBg: "hover:bg-blue-600" },
    { title: "AIIMS", image: medical.src, bgColor: "bg-green-400", hoverBg: "hover:bg-green-600" },
    { title: "JIPMER", image: medical.src, bgColor: "bg-purple-400", hoverBg: "hover:bg-purple-600" },
    { title: "CMC Vellore", image: medical.src, bgColor: "bg-red-400", hoverBg: "hover:bg-red-600" },
    { title: "AFMC", image: medical.src, bgColor: "bg-yellow-400", hoverBg: "hover:bg-yellow-600" },
    { title: "AMU MBBS", image: medical.src, bgColor: "bg-indigo-400", hoverBg: "hover:bg-indigo-600" },
  ];
    ...
    <>
      ...
      <section className="relative bg-gradient-to-t from-blue-100 to-white py-28 overflow-hidden mb-24">
        <div className="container max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6">
          <div className="md:w-1/2 space-y-6 text-left">
            <h1 className="text-5xl font-bold text-gray-900">Crack NEET UG 2025</h1>
          ...
          <div className="relative flex md:w-1/2 h-[500px]">
            <motion.div className="absolute -top-48 right-[-180px] w-[300px] h-[500px] overflow-hidden" style={{ y: parallaxY1 }}>
              <Image src={bgImage2} alt="NEET Image 1" fill className="rounded-2xl object-cover" />
            </motion.div>
            <motion.div className="absolute -bottom-96 left-20 w-[350px] h-[380px] overflow-hidden" style={{ y: parallaxY2 }}>
              <Image src={bgImage3} alt="NEET Image 2" fill className="rounded-2xl object-cover" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center">
        <div className="container mx-auto px-6 lg:px-20">
          <h2 className="text-4xl font-bold text-gray-800 mb-12">Explore Our Medical Test Series</h2>
...
<Roadmap/>
      <section className="text-center py-20 bg-gradient-to-t from-teal-100 to-white">
        <div className="container mx-auto px-6 lg:px-20">
          <h2 className="text-4xl font-bold text-gray-800 mb-12">Why Choose Our NEET 2025 Test Series?</h2>
      ...
      <section className="relative py-32 bg-blue-500 text-white text-center">
        <div className="container mx-auto">
          <h2 className="text-5xl font-bold mb-6">Start Your NEET 2025 Journey Today!</h2>
