  ...
  return (
    <>
        ...
        <div className="container max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6">
          <div className="md:w-1/2 space-y-6 text-left">
            ...
            <p className="text-2xl text-gray-600">
              Your roadmap to success with expert guidance and structured test
              series.
            </p>
            <a
              href="#test-series"
      ...
      <section className="text-center">
        <div className="container mx-auto px-6 lg:px-20">
          <h2 className="text-4xl font-bold text-gray-800 mb-12">
            Explore Our Medical Test Series
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            {medicalTests.map((test, index) => (
              <div
                key={index}
                className={`rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 ${test.bgColor} ${test.hoverBg}`}
              >
                <img
                  src={test.image}
                  alt={test.title}
      ...
      <section className="text-center py-20 bg-gradient-to-t from-teal-100 to-white">
        <div className="container mx-auto px-6 lg:px-20">
          <h2 className="text-4xl font-bold text-gray-800 mb-12">
            Why Choose Our NEET 2025 Test Series?
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
            <StepCard
              icon={<FaBook />}
              title="Concept Clarity"
              description="Detailed theory & video lectures"
              bgColor="bg-blue-600"
            />
            <StepCard
              icon={<FaClipboardCheck />}
              title="Practice Tests"
              description="Real exam-like mock tests"
              bgColor="bg-purple-600"
            />
            <StepCard
              icon={<FaChartLine />}
              title="Performance Analysis"
              description="Detailed test reports"
              bgColor="bg-orange-600"
            />
            <StepCard
              icon={<FaTrophy />}
              title="Success Strategies"
              description="Proven methods for high scores"
      ...
      <section className="relative py-32 bg-blue-500 text-white text-center">
        <div className="container mx-auto">
          <h2 className="text-5xl font-bold mb-6">
            Start Your NEET 2025 Journey Today!
          </h2>
          <p className="text-2xl mb-6">
            Join our test series and maximize your potential.
          </p>
          <a
            href="#register"
            className="inline-block bg-white text-blue-600 font-bold px-6 py-3 rounded-full transition hover:bg-gray-300"
          >
            Register Now
          </a>
        </div>
...
function StepCard({ icon, title, description, bgColor }) {
  return (
    <div
      className={`flex flex-col items-center p-6 rounded-xl shadow-lg transition-transform transform hover:scale-105 ${bgColor} text-white`}
    >
