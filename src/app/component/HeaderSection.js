    ...
    <div className="relative flex flex-col justify-center items-center h-screen w-full overflow-hidden">
      ...
      <header className="absolute top-0 left-0 w-full px-28 py-14 flex items-center justify-between z-20">
        ...
        <div className="flex gap-6">
          ...
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-purple-600 transition">
            <FaGithub size={24} />
          </a>
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-purple-600 transition">
            <FaLinkedin size={24} />
          </a>
        </div>
      </header>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: '0px',
          background: 'radial-gradient(50% 50% at 50% 50%, rgba(252, 212, 137, 0.6) 0%, rgba(252, 212, 137, 0.298) 62.48%, rgba(252, 212, 137, 0) 100%)',
          opacity: 1,
          display: 'block',
          width: '806.244px',
          height: '700px',
      ...
      <div className="relative z-10 text-center">
        <AnimatePresence mode="wait">
          ...
          >
            <p className="text-7xl font-semibold leading-relaxed bg-clip-text text-transparent gradient-heading">"{quotes[index].text}"</p>
          </motion.div>
        </AnimatePresence>
        
        <button className="mt-8 px-8 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-xl text-lg font-semibold hover:scale-105 transition-transform">
          Get Started
        </button>
      </div>
